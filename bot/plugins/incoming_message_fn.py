        ...
        try:
            ...
            if user.status == "kicked":
                await message.reply_text(
                    text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/My_Bot_Updates).",
                    parse_mode="markdown",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton('📢Channel', url='https://t.me/My_Bot_Updates'),
                    InlineKeyboardButton('✳️Source', url='https://t.me/My_Bot_Updates')
                ],
                [
                    InlineKeyboardButton('🖥️Tutorial Video🖥️', url='https://t.me/My_Bot_Updates')
                ]
            ]
        ),
